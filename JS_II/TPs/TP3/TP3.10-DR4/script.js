...
figurasHistoricas.forEach(e => {
  totalCaracteres += e.nome.length + e.sobrenome.length;
  
});

console.log(totalCaracteres);
//o exercício não foi claro se queria nome completo ou não
//somente o nome, apenas retiramos e.sobrenome.length