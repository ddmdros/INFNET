...
let isMesNascEFalecimentoIgual = figurasHistoricas.filter(e => e.mesNascimento === e.mesFalecimento);

let nomeCompletoMesEFalencimentoIgual = isMesNascEFalecimentoIgual.map(e =>`${e.nome} ${e.sobrenome}`);

console.log(nomeCompletoMesEFalencimentoIgual);
console.log(isMesNascEFalecimentoIgual);
