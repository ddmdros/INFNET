...
let figurasNascidasEmJunho = figurasHistoricas.filter(e =>e.mesNascimento === "junho");
let qtdFigurasNascidasEmJunho = 0;

figurasNascidasEmJunho.forEach(() => { 
  qtdFigurasNascidasEmJunho++
});

console.log(qtdFigurasNascidasEmJunho);