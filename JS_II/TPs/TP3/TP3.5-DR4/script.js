...
let ativistas = figurasHistoricas.filter(e => e.profissao.toLowerCase().includes("ativista"));
let qtAtivistas = ativistas.length;

let somaIdadeAtivistas = 0;

ativistas.forEach(e => {
    somaIdadeAtivistas += e.idade;
});

let mediaIdadeAtivistas = somaIdadeAtivistas/qtAtivistas;
console.log(mediaIdadeAtivistas.toFixed(2));
