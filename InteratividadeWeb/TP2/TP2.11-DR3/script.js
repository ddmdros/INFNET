...
let cenoura = document.createElement("li");
cenoura.textContent = "cenoura";

lista.replaceChild(cenoura, lista.lastElementChild);

cenoura.style.border = "1px solid white";
cenoura.style.textAlign = "center";
cenoura.style.padding = "10px";

let segundaImg = document.querySelector("#galeria img:nth-child(2)");
let primeiroItemLista = segundaImg.parentElement.parentElement.firstElementChild.firstElementChild.firstElementChild;
alert(primeiroItemLista.textContent);

let srcPrimeiraImg = body.lastElementChild.firstElementChild.src;
alert(srcPrimeiraImg);