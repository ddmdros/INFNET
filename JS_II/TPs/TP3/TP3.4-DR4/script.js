...
const nomesCompletos = figurasHistoricas
.filter(e => e.nacionalidade === "inglesa" || e.nacionalidade === "estadunidense")
.map(e => `${e.nome} ${e.sobrenome}`);
console.log(nomesCompletos);

//Comecei fazendo um por um e depois juntei tudo
// let inglesesAndEstadunidenses = figurasHistoricas.filter( e => e.nacionalidade === "inglesa" || e.nacionalidade === "estadunidense");
// let nomesCompletosInglesesEEstadunidenses = inglesesAndEstadunidenses.map(e => e.nome + " " + e.sobrenome);
// console.log(nomesCompletosInglesesEEstadunidenses);