...
let contribuicoesComFisico = figurasHistoricas
.filter(e => e.profissao.toLowerCase().includes("físico"))
.map(e => e.contribuicoes)
.flat();
//.includes(físic) incluiria Marie Curie (física), mas segui exatamente o que o exercício pediu
console.log(contribuicoesComFisico);